...
@Component({
  selector: 'app-order-success-detail',
  templateUrl: './order-success-detail.component.html',
  styleUrls: ['./order-success-detail.component.scss'],
})
export class OrderSuccessDetailComponent implements OnInit {
  @Input() orderItem: any;
  ...
  cancelOrder(orderItemId) {
    const postData = { orderItemId: this.orderItem.orderItemId };
