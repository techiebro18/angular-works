...
@Component({
  selector: 'app-refused-items',
  templateUrl: './refused-items.component.html',
  styleUrls: ['./refused-items.component.scss'],
})
export class RefusedItemsComponent implements OnInit, OnDestroy {
  ...
  private getProductSearchFilter() {
    return {
      approval_status: ProductApprovalStatusEnum.REJECTED,
      draft: true,
