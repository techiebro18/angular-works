...
// This code was extracted from https://stackblitz.com/edit/angular-compress-image-y6gzrd?file=src%2Fapp%2Fcompress-image.service.ts
  ...
  compress(file: File): Observable<File> {
    ...
    return Observable.create(observer => {
      ...
      reader.onload = ev => {
        ...
        const imgWH = img.width > img.height
          ? img.width
          : img.height;
